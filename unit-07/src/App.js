  ...
  render() {
    return (
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/" />
          <Route path="/coffee" render={props => <PhotoContainer
            title="coffee"
            data={this.state.coffee} />}
          />
          <Route path="/books" render={props => <PhotoContainer
            title="books"
            data={this.state.books} />}
          />
          <Route path="/computers" render={props => <PhotoContainer
            title="computers"
            data={this.state.computers} />}
          />
          <Route path={'/search/:term'} render={props => <PhotoContainer
            title={this.state.searchTerm}
            data={this.state.search}
            loading={this.state.loading} />} />
          <Route render={props => <PhotoContainer
            title="404" />}
          />
        </Switch>
      </BrowserRouter>
